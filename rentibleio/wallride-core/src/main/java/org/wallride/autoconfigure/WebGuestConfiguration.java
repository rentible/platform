...
public class WebGuestConfiguration extends DelegatingWebMvcConfiguration {
	...
	public static class ControllerConfigration {
		...
		@Bean
		@ConditionalOnMissingBean
		public UserVerificationController userVerificationController() {
			return new UserVerificationController();
		}
		...
		@Bean
		@ConditionalOnMissingBean
		public FlatmateController FlatmateController() {
			return new FlatmateController();
		}

		@Bean
		@ConditionalOnMissingBean
		public PropertyViewController PropertyViewController() {
			return new PropertyViewController();
		}

		@Bean
		@ConditionalOnMissingBean
		public FlatmateViewController FlatmateViewController() {
			return new FlatmateViewController();
		}
